...
function windowView(s: Scene, x: number, y: number, w: number, h: number, city: boolean): void {
  ...
  if (s.time === 'night') {
    for (let i = 0; i < 18; i++)
      parts.push(
        el('circle', {
          cx: x + s.rng.float(0, w),
          cy: y + s.rng.float(0, h * 0.6),
          r: 1.8,
          fill: '#ffffff',
        }),
      );
    ...
    parts.push(
      el('circle', {
        cx: x + w * 0.75,
        cy: y + h * (s.time === 'sunset' ? 0.7 : 0.25),
        r: 30,
        fill: s.time === 'sunset' ? '#ffd98a' : '#fff8e0',
      }),
    );
    parts.push(
      el('ellipse', {
...
function frame(s: Scene, x: number, y: number, w: number, h: number, color: string, cross = true): void {
  ...
  if (cross)
    s.b.e('path', {
      d: d('M', x + w / 2, y, 'V', y + h, 'M', x, y + h / 2, 'H', x + w),
      stroke: color,
      'stroke-width': 8,
    });
  s.b.e('rect', {
...
function pendant(s: Scene, x: number, len: number, color: string): void {
  ...
  s.b.e('path', {
    d: d('M', x - 38, len + 40, 'Q', x, len - 16, x + 38, len + 40, 'Z'),
    fill: s.L(color),
    ...s.b.line(0.8),
  });
  s.b.e('ellipse', {
...
function cup(s: Scene, x: number, y: number, color: string): void {
  s.b.e('path', {
    d: d('M', x - 14, y - 20, 'H', x + 14, 'L', x + 11, y, 'H', x - 11, 'Z'),
    fill: s.L(color),
    ...s.b.line(0.5),
  });
  s.b.e('path', {
    d: d('M', x + 13, y - 16, 'q', 10, 2, 0, 10),
    fill: 'none',
    stroke: s.L(color),
    'stroke-width': 4,
  });
...
export function bedroom(s: Scene): void {
  ...
  s.b.e('path', {
    d: 'M120 70C150 200 110 300 130 400L200 400C170 300 190 180 180 70Z',
    fill: curtain,
    ...s.b.line(0.8),
  });
  s.b.e('path', {
    d: 'M500 70C470 200 510 300 490 400L420 400C450 300 430 180 440 70Z',
    fill: shade(curtain, -0.1),
    ...s.b.line(0.8),
  });
  ...
  s.b.e('path', {
    d: 'M880 440C1000 430 1150 430 1260 450L1260 600L870 600Z',
    fill: s.L(s.accent ?? '#e0708a'),
    ...s.b.line(1),
  });
  s.b.e('path', {
    d: 'M880 470C1000 460 1150 462 1260 478',
    fill: 'none',
    stroke: s.L('#ffffff'),
    'stroke-width': 8,
    opacity: 0.5,
  ...
  for (let i = 0; i < 4; i++)
    s.b.e('rect', {
      ...
      width: 16,
      height: 50 + (i % 2) * 8,
      fill: s.L(['#c84a4a', '#4a7ac8', '#e0b040', '#5aa05a'][i] as string),
      ...s.b.line(0.4),
    });
  s.b.e('ellipse', {
    cx: 560,
    ...
    rx: 220,
    ry: 40,
    fill: s.L(s.accent ? shade(s.accent, 0.3) : '#b8a0d8'),
    opacity: 0.85,
  });
  ambience(s);
}
...
export function classroom(s: Scene): void {
  ...
  for (const x of [200, 640, 1080])
    s.b.e('rect', {
      ...
      height: 14,
      rx: 4,
      fill: s.time === 'night' ? '#8a8a70' : '#ffffff',
    });
  planks(s, 520, '#b88a5a');
  ...
  s.b.e('path', {
    d: 'M380 180Q420 150 460 180T540 180M700 160L760 260L640 260Z',
    fill: 'none',
    stroke: s.L('#e8f0e8'),
    'stroke-width': 4,
    opacity: 0.7,

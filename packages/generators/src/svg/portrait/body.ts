...
const TORSO_SHADOW =
  'M392 500C438 512 464 540 474 590C486 660 484 760 488 900L432 900C440 760 436 640 418 580C408 550 400 520 392 500Z';
...
function mirror(path: string): string {
  ...
  return path.replace(
    /(-?\d+(?:\.\d+)?)[ ,](-?\d+(?:\.\d+)?)/g,
    (_m, x: string, y: string) => `${600 - Number(x)} ${y}`,
  );
}
...
export function drawBody(b: SvgBuilder, id: PortraitIdentity, c: BodyColors): string {
  ...
  const parts: string[] = [
    ...
    el('path', {
      d: 'M172 610C166 700 168 800 172 900M428 610C434 700 432 800 428 900',
      fill: 'none',
      stroke: oDark,
      'stroke-width': 4,
      opacity: 0.7,
  ...
  switch (id.outfitKind) {
    case 'school': {
      ...
      parts.push(
        el('path', { d: lapel, fill: oDark, ...line }),
        el('path', { d: mirror(lapel), fill: oDark, ...line }),
      );
      const collar = 'M266 488L290 538L300 506Z';
      parts.push(
        el('path', { d: collar, fill: white, stroke: whiteShade, 'stroke-width': 2 }),
        el('path', { d: mirror(collar), fill: white, stroke: whiteShade, 'stroke-width': 2 }),
      );
      const a = id.accent;
      parts.push(
    ...
    case 'casual': {
      const hood =
        'M232 500C246 470 354 470 368 500C392 516 402 540 392 566C356 532 244 532 208 566C198 540 208 516 232 500Z';
      parts.push(el('path', { d: hood, fill: oDark, ...line }));
      parts.push(el('path', { d: 'M266 494Q300 536 334 494Z', fill: id.accent, ...line }));
      parts.push(
        el('path', {
          d: 'M284 528L278 640M316 528L322 640',
          stroke: '#f0eef6',
          'stroke-width': 4,
    ...
    case 'fantasy': {
      ...
      const cloak =
        'M270 488C220 498 152 508 126 548C100 588 96 700 96 900L172 900C176 760 192 640 240 562C252 540 262 512 270 488Z';
      parts.push(el('path', { d: 'M278 490L300 566L322 490Z', fill: c.skin }));
      parts.push(
        el('path', {
          d: 'M278 490L300 566L322 490',
          fill: 'none',
          stroke: '#e8c060',
          'stroke-width': 5,
    ...
    case 'formal': {
      ...
      parts.push(
        ...
        el('path', {
          d: 'M296 560L312 548M290 600L314 584',
          stroke: shade(tie, -0.3),
          'stroke-width': 3,
          opacity: 0.6,
        }),
      );
